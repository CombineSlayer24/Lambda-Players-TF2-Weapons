...
CreateLambdaConvar( "lambdaplayers_tf2_spawnonfullcharge", 0, true, false, false, "If Lambda Player's buff items should be full when spawned. (Buff Banners, Mediguns, Phlog)", 0, 1, { type = "Bool", name = "Spawn With Full Charge", category = "TF2 Stuff" } )
